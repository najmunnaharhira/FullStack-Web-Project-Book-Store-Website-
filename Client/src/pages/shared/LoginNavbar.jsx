...
//                             {isMenuOpen ? <FaXmark className="text-xl" /> : <FaBarsStaggered className="text-xl" />}
//                         </button>
//                     </div>
//                 </div>
//             </div>
...
//         {/* Mobile Menu */}
//         {isMenuOpen && (
//             <div className="md:hidden absolute top-16 left-0 w-full bg-white z-10 shadow-lg">
...
//                                     target="_blank"
//                                     rel="noopener noreferrer"
//                                     className="text-base cursor-pointer uppercase text-violet-500 hover:text-blue-600 transition duration-200"
//                                 >
//                                     <img
//                                         src="https://c8.alamy.com/comp/R1T9CB/shop-vector-icon-isolated-on-transparent-background-shop-transparency-logo-concept-R1T9CB.jpg"
//                                         alt="Become a Seller"
...
//         )}
        ...
        //         <div className="relative bg-white p-8 rounded-lg shadow-lg z-10 w-full max-w-lg mx-auto">
        //             <CartDetails />
        //             <button
                            ...
                            <li key={link} className="flex justify-center">
                                {external ? (
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="text-base cursor-pointer uppercase text-black hover:text-blue-700 underline italic"
                                    >
                                        <img
                                            src="https://c8.alamy.com/comp/R1T9CB/shop-vector-icon-isolated-on-transparent-background-shop-transparency-logo-concept-R1T9CB.jpg"
                                            alt="Become a Seller"
                                            className="w-8 h-8 inline-block mr-2 rounded-full object-cover"
                                        />
                                        Become a Seller
                                    </a>
                                ) : (
                                    <Link to={path} className="text-base cursor-pointer uppercase text-black hover:text-blue-700 underline italic">
                                        {link}
                                    </Link>
                                )}
                            </li>
